<script>
    ...
    import BinanceData, { fetchBinanceData, CACHE_dataStore }  from '../../stores/dataStore'
    ...
    onMount(async()=>{   
         await fetchBinanceData(`https://api.binance.com/api/v3/exchangeInfo?symbol=${$Symbol}`, 'symbol')
